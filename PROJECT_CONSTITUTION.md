...
`MASTER_SPEC.md`
`ARCHITECTURE.md`
Data Schema / Rule Specification
Task Specification
Implementation
AI Suggestion
...
Nhận nhiều loại chứng từ khác nhau.
Hiểu chứng từ có layout không cố định.
Chuẩn hóa dữ liệu từ nhiều nguồn.
Đối chiếu dữ liệu giữa các chứng từ.
Kiểm tra theo loại hình tờ khai.
Kiểm tra theo rule nghiệp vụ.
Phát hiện dữ liệu thiếu, sai hoặc bất thường.
Truy vết được kết luận về chứng từ nguồn.
Biết rõ khi nào hệ thống không đủ cơ sở kết luận.
Giảm tối đa chi phí vận hành AI.
